...
import { convertValue, defaultFormData, transformValue } from '@/pages/order/src/form/utils';
  ...
  return (
    <div className={styles.LayoutContainer}>
      ...
      <Spin spinning={loading} wrapperClassName={styles.content}>
        <ProForm<OrderFormProps> formRef={formRef} submitter={false} scrollToFirstError={true} omitNil>
          <BasicForm />
        </ProForm>
      </Spin>
      <Space className={styles.footer}>
        <Button onClick={confirmBack}>取消</Button>
        <Button htmlType={'submit'} type="primary" onClick={onSubmit} loading={loading}>
          保存
        </Button>
      </Space>
    </div>
